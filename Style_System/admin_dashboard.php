...
<div class="topnav">
    <div class="nav-left">
        <h2>🎓 ScholarFlow <span class="admin-badge">Admin Panel</span></h2>
    </div>
    <div class="nav-right">
    ...
    <div class="modal-content" style="max-width: 1000px; max-height: 90vh; overflow-y: auto;">
        ...
        <div class="modal-body">
            <form method="POST">
                ...
                <h4 style="color: #771111; margin: 20px 0 15px 0; padding-bottom: 8px; border-bottom: 2px solid #e3f2fd; display: flex; align-items: center; gap: 8px;">
                    👤 Personal Information
                </h4>
                ...
                <!-- Education Section -->
                <h4 style="color: #771111; margin: 30px 0 15px 0; padding-bottom: 8px; border-bottom: 2px solid #e3f2fd; display: flex; align-items: center; gap: 8px;">
    ...
    details.innerHTML = `
        <div class="detail-grid">
            ...
            <div class="detail-item">
                ...
                <p>${data.document ? `<a href="uploads/${data.document}" target="_blank" style="color: #771111; font-weight: 600;">📄 View Document</a>` : 'No file uploaded'}</p>
            </div>
            <div class="detail-item">
                <label>Status</label>
